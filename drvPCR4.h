 ...
 * drvPCR4.h
 * 
 * Asyn driver that inherits from the drvQuadEM class to control the SenSic PCR4 4-channel picoammeter
 *
 * Author: Mark Rivers
 *
...
/** Class to control the SenSic PCR4 4-Channel Picoammeter */
class drvPCR4 : public drvQuadEM {
public:
